...
static void world_create(BiContext* context)
{
    ...
    BiShader *mosaic_shader = malloc(sizeof(BiShader));
    bi_shader_init(wave_shader,context->w,context->h, VERTEX_SHADER, WAVE_FRAGMENT_SHADER);
    bi_shader_init(mosaic_shader,context->w,context->h, VERTEX_SHADER, MONOCHROME_FRAGMENT_SHADER);
